...
public class _01_ApiTest {
    ...
    public void statusCodeTest() {
        ...
        given()
                ...
                .then()
                .log().body() // gelen body kismini göster, all() dersek body() yerine her seyi gösterir bilgileri.
    ...
    public void checkCountryInResponseBody() {
        ...
        // bulundu yeri (path i) vererel icerde assertion hamcrest kütüphanesi yapiyor
        ;
    }

    @Test
    public void checkCaliforniaInResponseBody() {
    ...
    public void checkHasItemBody() {
        ...
        given()
                ...
                .body("places.'place name'", hasItem("Dörtağaç Köyü")) // places icindeki bütün place name ler in
        // icinde Dörtagac köyü varmi
        ;
    }
    ...
    public void bodyArrayHasSizeTest() {
        ...
        given()
                ...
                .body("places", hasSize(1)) // places in eleman sayisi 1 mi
        ;
    }
    ...
    public void combiningTest() {
        given()
                ...
                .then()
                //.log().body()
                .body("places", hasSize(1))    // placesin eleman uzunlugu 1 mi
